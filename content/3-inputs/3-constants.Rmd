...
This file lists all constants and their values used in ARCHIMED. The file is optional. The example file provided below lists the default values used in ARCHIMED (their values are also provided in this page for information).
...
- `co2_to_heat_boundary_layer_conductance` is used to convert the boundary layer conductance to heat into the boundary layer conductance to $CO_2$ with the following equation (default value is 1.32):
