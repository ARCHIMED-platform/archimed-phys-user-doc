...
You can run ARCHIMED with any of these options enabled, but at the moment it is best not digging into much details about this. We will see those details later in the [documentation for power users](../../2-inputs/7-power_users/). 
