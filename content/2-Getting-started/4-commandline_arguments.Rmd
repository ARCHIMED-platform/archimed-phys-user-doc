...
The `java -jar archimed.jar` part of the command just tells Java to execute the `archimed.jar` file, and the second one (`config.yml`) is an argument used to give the path to the configuration file to ARCHIMED-φ.
