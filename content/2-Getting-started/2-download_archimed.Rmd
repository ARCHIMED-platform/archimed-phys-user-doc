...
The `java -jar archimed.jar` part of the command just tells Java to execute the `archimed.jar` file. If your ARCHIMED-φ `.jar` file is named differently, please name it properly, e.g.: 
